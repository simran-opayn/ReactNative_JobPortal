...
const ApplicantsListView = ({navigation=useNavigation()}) => {
    const jobs = [{id: 1, image: ImagesPath.userwhiteImg}, {id: 2, image: ImagesPath.addUserImg}, {id: 3, image: ImagesPath.activeUserImg}, {id: 4, name: ImagesPath.activeUserImg},
        {id: 5, image: ImagesPath.userwhiteImg}, {id: 6, image: ImagesPath.addUserImg}, {id: 7, image: ImagesPath.activeUserImg}, {id: 8, name: ImagesPath.activeUserImg}];
        ...
        <SafeAreaView style={{backgroundColor: color.mainColor, flex: 1}}>
            ...
            <View style={[CustomStyling.curveViewStyle, {padding: 0}]}>
                ...
                <FlatList 
                    ...
                    renderItem={({item}) => (
                        <TouchableOpacity style={[{flexDirection: "row"}, CustomStyling.cardStyle]} onPress={() => navigation.navigate("ApplicantDetail")}>
                            <Image 
                                source={item.image}
                            ...
                            <View style={{paddingHorizontal: 8, width: "70%"}}>
                                <Text style={{fontSize: 16, fontFamily: fonts.semiBold, color: color.mainColor, marginBottom: 4}}>John Smith</Text>
                                <Text  style={{fontSize: 14, fontFamily: fonts.semiBold, color: color.titleBlack}}>5 Years Experience</Text>
                                <View style={{flexDirection: 'row', alignItems: "center", marginVertical: 4}}>
                                    <Text  style={{fontSize: 14, fontFamily: fonts.medium, color: color.darkGray}}>Associate Developer</Text>
                                ...
                                <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                                    <Text  style={{fontSize: 16, fontFamily: fonts.medium, color: color.darkGray}}>Applied for Sr. Developer</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    )}
