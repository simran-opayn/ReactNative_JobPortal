...
const AppliedJobsListView = ({navigation=useNavigation()}) => {
                        ...
                        <TouchableOpacity style={[{flexDirection: "row"}, CustomStyling.cardStyle]} onPress={() => navigation.navigate("JobDetail")}>
                            ...
                            <View style={{paddingHorizontal: 8, width: "70%"}}>
                                <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                                    ...
                                    <Text style={{fontSize: 14, fontFamily: fonts.semiBold, color: color.mainColor, marginBottom: 4}}>Applied on : 25th Feb, 2022</Text>
                                </View>
...
export default AppliedJobsListView;